...
namespace Trakx.Circle.ApiClient.Utils
{
    ...
    {
        internal const string ApiKeyHeader = "CIRCLE-API-KEY";
        internal const string ApiNonceHeader = "CIRCLE-API-NONCE";
        internal const string ApiSignatureHeader = "CIRCLE-API-SIGNATURE";
