...
namespace Trakx.Circle.ApiClient
{
    ...
    public partial interface IAccountsClient
    {
        ...
        System.Threading.Tasks.Task<Response<BalancesResponse>> GetBalancesAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    internal partial class AccountsClient : AuthorisedClient, IAccountsClient
    {
        ...
        /// <returns>Successfully retrieved balances.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response<BalancesResponse>> GetBalancesAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<BalancesResponse>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            return new Response<BalancesResponse>(status_, headers_, objectResponse_.Object);
                        }
                        else
                        if (status_ == 401)
                        {
    ...
    {
        /// <summary>List of currency balances (one for each currency) that are currently available to spend.</summary>
        ...
        /// <summary>List of currency balances (one for each currency) that have been captured but are currently in the process of settling and will become available to spend at some point in the future.</summary>
    ...
    {
        /// <summary>Magnitude of the amount, in units of the currency, with a `.` decimal.</summary>
